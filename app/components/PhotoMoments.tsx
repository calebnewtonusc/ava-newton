...
const photos = [
  ...
  {
    src: "/photos/ava-show.jpeg",
    caption: "Here Lies Love",
    sub: "Showed up to a Broadway show looking like that",
    objPos: "center 20%",
    span: "col-span-2 row-span-1",
    height: "h-72",
  },
  {
    src: "/photos/ava-chaos.jpeg",
    caption: "Certified Chaos Agent",
    sub: "Upside down and loving it",
    objPos: "center center",
    span: "col-span-1 row-span-1",
    height: "h-64",
  },
